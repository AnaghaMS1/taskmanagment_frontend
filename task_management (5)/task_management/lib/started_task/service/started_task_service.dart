...
import 'package:task_management/started_task/model/started_task_model.dart';

Future<StartedTaskModel>  started_task_service(
   ) async {
  Box? box1;
  ...
  try {
    ...
    if (resp.statusCode == 200) {
      final response = StartedTaskModel.fromJson(decoded);
      return response;
    } else {
